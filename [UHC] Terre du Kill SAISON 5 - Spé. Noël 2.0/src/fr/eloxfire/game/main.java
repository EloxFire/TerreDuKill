...
public class main extends JavaPlugin {
	...
	public void onEnable() {
		...
		getServer().getConsoleSender().sendMessage("§6[T.D.K]§2 Terre du Kill SAISON 5 ON !");
		...
		pm.registerEvents(new cadeauEvent(), this); // CLASSE QUI GERE LES CADEAUX DE NOËL
	...
	public void onDisable() {
		...
		getServer().getConsoleSender().sendMessage("§6[T.D.K]§2 Terre du Kill SAISON 5 OFF !");
	}
